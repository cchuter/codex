...
//!
//! The history is stored at `~/.osmiflow/history.jsonl` with **one JSON object per
...
/// Filename that stores the message history inside `~/.osmiflow`.
...
pub(crate) async fn append_entry(
    ...
    // Resolve `~/.osmiflow/history.jsonl` and ensure the parent directory exists.
