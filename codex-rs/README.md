...
The same setting can be persisted in `~/.osmiflow/config.toml` via the top-level `sandbox_mode = "MODE"` key, e.g. `sandbox_mode = "workspace-write"`.
